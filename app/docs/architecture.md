...
L'accès Direction est attribué localement dans `app.direction_users`, sans changer l'ERP. L'observation facultative saisie avec une déclaration est conservée et consultable par la Direction.
